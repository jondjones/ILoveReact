...
var Instrumenter = exports.Instrumenter = function (_istanbul$Instrumente) {
  ...
  function Instrumenter() {
    ...
    var _this = _possibleConstructorReturn(this, (Instrumenter.__proto__ || Object.getPrototypeOf(Instrumenter)).call(this));
  ...
  _createClass(Instrumenter, [{
    ...
    value: function getPreamble(sourceCode, emitUseStrict) {
      ...
      return _get(Instrumenter.prototype.__proto__ || Object.getPrototypeOf(Instrumenter.prototype), 'getPreamble', this).call(this, sourceCode, emitUseStrict);
    }
    ...
    value: function _statementMapTransformer(metrics) {
      ...
      return Object.keys(metrics).map(function (index) {
        ...
        var _getMetricOriginalLoc = _this3._getMetricOriginalLocations([statementMeta]),
            _getMetricOriginalLoc2 = _slicedToArray(_getMetricOriginalLoc, 1),
            location = _getMetricOriginalLoc2[0];
    ...
    value: function _fnMapTransformer(metrics) {
      ...
      return Object.keys(metrics).map(function (index) {
        ...
        var _getMetricOriginalLoc3 = _this4._getMetricOriginalLocations([fnMeta.loc]),
            _getMetricOriginalLoc4 = _slicedToArray(_getMetricOriginalLoc3, 1),
            loc = _getMetricOriginalLoc4[0];
    ...
    value: function _getOriginalPositionsFor() {
      ...
      var generatedPositions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { start: {}, end: {} };

    ...
    create(context, [{ ignoreConditionalTests, ignoreMixedLogicalExpressions }]) {
        ...
        return {
            'LogicalExpression[operator = "||"]'(node) {
                ...
                const barBarOperator = sourceCode.getTokenAfter(node.left, token => token.type === experimental_utils_1.AST_TOKEN_TYPES.Punctuator &&
                    token.value === node.operator); // there _must_ be an operator
